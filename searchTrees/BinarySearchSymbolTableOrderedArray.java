...
public class BinarySearchSymbolTableOrderedArray<Key extends Comparable<Key>, Value> {
    ...
    public BinarySearchSymbolTableOrderedArray() { this(INIT_CAPACITY); }   

    // create an empty symbol table with given initial capacity
    public BinarySearchSymbolTableOrderedArray(int capacity) { 
    ...
    *****************************************************************************/
    public static void main(String[] args) { 
        BinarySearchSymbolTableOrderedArray<String, Integer> st = new BinarySearchSymbolTableOrderedArray<String, Integer>();
